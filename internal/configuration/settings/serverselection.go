...
func (ss *ServerSelection) overrideWith(other ServerSelection) {
	...
	ss.Countries = helpers.OverrideStringSlices(ss.Countries, other.Countries)
	ss.Regions = helpers.OverrideStringSlices(ss.Regions, other.Regions)
	ss.Cities = helpers.OverrideStringSlices(ss.Cities, other.Cities)
	ss.ISPs = helpers.OverrideStringSlices(ss.ISPs, other.ISPs)
	ss.Hostnames = helpers.OverrideStringSlices(ss.Hostnames, other.Hostnames)
	ss.Names = helpers.OverrideStringSlices(ss.Hostnames, other.Names)
	ss.Numbers = helpers.OverrideUint16Slices(ss.Numbers, other.Numbers)
