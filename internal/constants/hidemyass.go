...
func HideMyAssServers() []models.HideMyAssServer {
	return []models.HideMyAssServer{
		...
		{Country: "Antiguaand Barbuda", Region: "", City: "Saint John%27s", Hostname: "ag.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 56, 12}, {5, 62, 58, 12}}},
		...
		{Country: "Austria", Region: "Carinthia", City: "Klagenfurt", Hostname: "at.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{91, 132, 139, 115}, {94, 198, 41, 110}, {94, 198, 41, 126}, {185, 183, 107, 147}, {185, 244, 212, 30}, {185, 244, 212, 35}, {185, 244, 212, 190}}},
		...
		{Country: "Belgium", Region: "", City: "Brussels", Hostname: "be.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 20, 24}, {5, 62, 20, 33}, {5, 62, 20, 34}}},
		...
		{Country: "Brazil", Region: "", City: "Joao Pessoa", Hostname: "br.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{179, 61, 215, 95}, {181, 215, 238, 143}, {191, 96, 4, 207}, {191, 96, 5, 163}, {191, 96, 5, 223}, {191, 96, 9, 143}, {191, 96, 13, 143}}},
		...
		{Country: "Canada", Region: "British Columbia", City: "Vancouver", Hostname: "ca.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{51, 161, 54, 15}, {51, 161, 66, 111}, {54, 39, 219, 127}, {158, 69, 234, 207}, {192, 99, 89, 207}, {192, 99, 110, 159}, {198, 27, 103, 191}}},
		...
		{Country: "Chad", Region: "", City: "N%27 Djamena", Hostname: "td.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 60, 80}, {5, 62, 62, 80}}},
		...
		{Country: "Coted%60 Ivoire", Region: "", City: "Yamoussoukro", Hostname: "ci.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 60, 104}, {5, 62, 62, 100}}},
		...
		{Country: "Czech Republic", Region: "", City: "Prague", Hostname: "cz.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{185, 246, 210, 130}, {185, 246, 210, 146}, {185, 246, 210, 162}, {185, 246, 210, 178}, {212, 102, 38, 173}, {212, 102, 38, 186}}},
		{Country: "Denmark", Region: "", City: "Copenhagen", Hostname: "dk.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{2, 58, 46, 195}, {2, 58, 46, 211}, {95, 174, 65, 142}, {185, 212, 169, 174}, {185, 212, 169, 206}}},
		...
		{Country: "Finland", Region: "", City: "Helsinki", Hostname: "fi.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{185, 77, 217, 31}, {185, 77, 217, 61}, {185, 77, 217, 76}, {185, 77, 217, 91}, {185, 77, 217, 106}}},
		{Country: "France", Region: "", City: "Paris", Hostname: "fr.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{84, 17, 43, 90}, {84, 17, 43, 103}, {84, 17, 43, 116}, {185, 93, 2, 50}, {185, 93, 2, 114}, {195, 154, 43, 224}, {212, 83, 190, 56}}},
		...
		{Country: "Germany", Region: "Hesse", City: "Frankfurt", Hostname: "de.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 41, 121}, {5, 62, 41, 133}, {5, 62, 41, 145}, {5, 62, 41, 157}, {5, 62, 41, 181}}},
		...
		{Country: "Ireland", Region: "", City: "Dublin", Hostname: "ie.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{78, 153, 199, 29}, {78, 153, 199, 243}, {78, 153, 199, 254}}},
		...
		{Country: "Italy", Region: "Pordenone", City: "Porcia", Hostname: "it.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{45, 87, 184, 15}, {45, 87, 184, 31}, {45, 87, 184, 79}, {45, 87, 184, 95}, {84, 17, 58, 168}, {84, 17, 58, 213}, {84, 17, 59, 45}, {84, 17, 59, 59}}},
		...
		{Country: "Mexico", Region: "Sinaloa", City: "Mazatlan", Hostname: "mx.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{31, 14, 72, 16}, {31, 14, 72, 23}, {31, 14, 72, 30}, {31, 14, 72, 37}, {31, 14, 72, 44}, {31, 14, 72, 51}}},
		...
		{Country: "New Zealand", Region: "", City: "Auckland", Hostname: "nz.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{103, 76, 164, 3}, {103, 76, 164, 19}, {103, 231, 91, 131}}},
		...
		{Country: "Norway", Region: "", City: "Oslo", Hostname: "no.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{185, 101, 32, 16}, {185, 101, 32, 32}, {185, 101, 32, 64}, {217, 170, 203, 128}, {217, 170, 204, 160}, {217, 170, 206, 15}, {217, 170, 206, 31}}},
		...
		{Country: "Portugal", Region: "", City: "Leiria", Hostname: "pt.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{91, 205, 230, 239}, {91, 250, 240, 113}, {91, 250, 240, 193}, {91, 250, 240, 209}, {195, 158, 248, 46}, {195, 158, 248, 94}}},
		...
		{Country: "Republicof Singapore", Region: "", City: "Singapore", Hostname: "sg.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 35, 143}, {5, 62, 35, 151}, {5, 62, 35, 159}, {89, 187, 163, 226}, {89, 187, 163, 250}, {92, 223, 85, 21}, {92, 223, 85, 22}}},
		...
		{Country: "Russia", Region: "", City: "Moscow", Hostname: "ru.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 19, 39}, {5, 62, 19, 47}, {5, 62, 19, 63}, {5, 62, 19, 71}}},
		...
		{Country: "South Africa", Region: "", City: "Johannesburg", Hostname: "za.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{196, 251, 250, 39}, {196, 251, 250, 57}, {196, 251, 250, 92}, {196, 251, 250, 137}, {196, 251, 250, 164}, {196, 251, 250, 174}, {196, 251, 250, 206}, {196, 251, 250, 229}}},
		...
		{Country: "Spain", Region: "", City: "Alicante", Hostname: "es.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{31, 13, 188, 3}, {82, 102, 17, 238}, {82, 102, 17, 254}, {89, 38, 226, 238}, {192, 145, 124, 78}, {217, 138, 218, 126}, {217, 138, 218, 238}}},
		...
		{Country: "Sweden", Region: "Stockholm", City: "Nacka", Hostname: "se.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{31, 3, 152, 98}, {31, 3, 152, 106}, {31, 3, 152, 118}, {31, 3, 152, 192}, {31, 3, 153, 140}, {37, 46, 121, 224}, {37, 46, 121, 240}, {128, 127, 105, 192}}},
		...
		{Country: "Taiwan", Region: "", City: "Taipei", Hostname: "tw.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{172, 107, 246, 110}, {172, 107, 246, 174}, {172, 107, 246, 190}, {172, 107, 246, 206}, {172, 107, 246, 222}}},
		...
		{Country: "UK", Region: "", City: "London", Hostname: "london.gb.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 43, 202}, {5, 62, 43, 218}, {5, 62, 43, 229}, {77, 234, 43, 130}, {77, 234, 43, 166}, {77, 234, 43, 175}, {77, 234, 43, 185}}},
		{Country: "UK", Region: "Scotland", City: "Glasgow", Hostname: "scotland.gb.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{62, 128, 207, 110}, {62, 128, 217, 69}, {62, 128, 217, 112}, {109, 169, 34, 23}, {109, 169, 34, 42}, {109, 169, 34, 62}}},
		{Country: "UK", Region: "", City: "", Hostname: "gb.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{62, 128, 207, 110}, {62, 128, 217, 69}, {62, 128, 217, 112}, {109, 169, 34, 23}, {109, 169, 34, 62}}},
		...
		{Country: "USA", Region: "Arizona", City: "Phoenix", Hostname: "az.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{23, 83, 130, 143}, {23, 83, 130, 187}, {23, 83, 131, 98}, {23, 83, 131, 113}, {23, 83, 131, 215}, {23, 83, 132, 155}, {23, 83, 132, 176}, {23, 83, 132, 186}}},
		{Country: "USA", Region: "Arkansas", City: "Magnolia", Hostname: "ar.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 57, 0}, {5, 62, 58, 236}}},
		{Country: "USA", Region: "California", City: "Los Angeles", Hostname: "ca.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{107, 181, 178, 97}, {107, 181, 178, 113}, {162, 253, 68, 145}, {192, 252, 220, 17}, {192, 252, 220, 60}}},
		...
		{Country: "USA", Region: "Georgia", City: "Atlanta", Hostname: "ga.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{5, 62, 24, 15}, {5, 62, 24, 46}, {5, 62, 24, 61}, {66, 115, 181, 193}, {66, 115, 181, 241}}},
		...
		{Country: "USA", Region: "Illinois", City: "Chicago", Hostname: "il.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{154, 16, 241, 255}, {181, 214, 54, 79}, {181, 214, 58, 176}, {181, 214, 61, 64}, {181, 214, 63, 24}, {181, 214, 102, 159}, {191, 101, 170, 30}}},
		...
		{Country: "USA", Region: "Massachusetts", City: "Boston", Hostname: "ma.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{38, 146, 52, 253}, {38, 146, 55, 115}, {38, 242, 7, 243}, {154, 3, 129, 29}, {154, 3, 222, 163}}},
		...
		{Country: "USA", Region: "New York", City: "Manhattan", Hostname: "ny.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{156, 146, 36, 90}, {212, 102, 33, 50}, {212, 102, 33, 90}, {212, 102, 33, 176}, {212, 102, 33, 224}, {212, 102, 33, 251}}},
		{Country: "USA", Region: "North Carolina", City: "Asheville", Hostname: "nc.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{104, 247, 208, 78}, {104, 247, 208, 94}, {104, 247, 208, 142}, {104, 247, 208, 158}, {104, 247, 208, 174}}},
		...
		{Country: "USA", Region: "Texas", City: "Dallas", Hostname: "tx.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{89, 187, 164, 86}, {89, 187, 164, 144}, {156, 146, 38, 141}, {156, 146, 38, 154}, {212, 102, 40, 13}, {212, 102, 40, 141}}},
		{Country: "USA", Region: "Utah", City: "Salt Lake City", Hostname: "ut.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{69, 36, 169, 129}, {199, 189, 106, 235}, {199, 189, 106, 239}, {199, 189, 106, 251}, {209, 95, 34, 73}}},
		...
		{Country: "USA", Region: "Washington", City: "Seattle", Hostname: "wa.us.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{66, 115, 149, 17}, {66, 115, 149, 33}, {66, 115, 149, 81}, {66, 115, 149, 113}, {66, 115, 149, 123}, {172, 98, 86, 182}, {172, 98, 86, 188}, {199, 187, 211, 172}, {199, 187, 211, 217}, {199, 187, 211, 232}}},
		...
		{Country: "Ukraine", Region: "", City: "Odessa", Hostname: "ua.hma.rocks", TCP: true, UDP: true, IPs: []net.IP{{31, 28, 162, 35}, {62, 149, 29, 158}, {62, 149, 29, 190}}},
