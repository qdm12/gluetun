...
func PurevpnServers() []models.PurevpnServer {
	return []models.PurevpnServer{
		...
		{Region: "Asia", Country: "Armenia", City: "Singapore", IPs: []net.IP{{37, 120, 208, 148}}},
		...
		{Region: "Asia", Country: "Hong Kong (SAR)", City: "Hong Kong", IPs: []net.IP{{172, 111, 168, 4}}},
		...
		{Region: "Europe", Country: "Belgium", City: "Brussels", IPs: []net.IP{{45, 12, 222, 18}}},
		...
		{Region: "Europe", Country: "Georgia", City: "Tbilisi", IPs: []net.IP{{188, 72, 101, 130}}},
		{Region: "Europe", Country: "Germany", City: "Frankfurt", IPs: []net.IP{{82, 102, 16, 108}}},
		{Region: "Europe", Country: "Germany", City: "Munich", IPs: []net.IP{{82, 102, 16, 108}}},
		{Region: "Europe", Country: "Germany", City: "Nuremberg", IPs: []net.IP{{172, 94, 125, 2}}},
		{Region: "Europe", Country: "Greece", City: "Thessaloniki", IPs: []net.IP{{5, 172, 199, 1}}},
		...
		{Region: "Europe", Country: "Ireland", City: "Dublin", IPs: []net.IP{{45, 12, 222, 18}}},
		...
		{Region: "Europe", Country: "Netherlands", City: "Amsterdam", IPs: []net.IP{{172, 83, 45, 115}}},
		...
		{Region: "North America", Country: "United States", City: "Chicago", IPs: []net.IP{{141, 101, 149, 4}}},
		...
		{Region: "North America", Country: "United States", City: "New Jersey", IPs: []net.IP{{46, 243, 249, 4}}},
		...
		{Region: "North America", Country: "United States", City: "Salt Lake City", IPs: []net.IP{{37, 230, 169, 4}}},
		{Region: "North America", Country: "United States", City: "San Francisco", IPs: []net.IP{{141, 101, 166, 4}}},
		{Region: "North America", Country: "United States", City: "Seattle", IPs: []net.IP{{172, 94, 86, 2}}},
		{Region: "North America", Country: "United States", City: "Washington, D.C.", IPs: []net.IP{{172, 111, 147, 4}}},
